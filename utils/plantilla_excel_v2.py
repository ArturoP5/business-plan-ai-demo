...
def crear_plantilla_v2():
    ...
    try:
        ...
        pass  # Si falla, continuar sin validaciones
    ...
    # Agregar validaciones para tipos de financiación
    try:
        tipos_str = '"Póliza crédito,Póliza crédito stock,Descuento comercial,Anticipo facturas,Factoring con recurso,Factoring sin recurso,Confirming proveedores,Pagarés empresa,Crédito importación"'
        dv_tipos = DataValidation(type="list", formula1=tipos_str, allow_blank=True)
        for row in range(2, 12):  # Aplicar a las primeras 10 filas
            dv_tipos.add(ws[f'A{row}'])
    ...
    ws.append(["Gastos Personal Año 1", 0, "Gastos de personal proyectados"])
    ws.append(["Gastos Personal Año 2", 0, "Gastos de personal proyectados"])
    ws.append(["Gastos Personal Año 3", 0, "Gastos de personal proyectados"])
    ws.append(["Gastos Personal Año 4", 0, "Gastos de personal proyectados"])
    ws.append(["Gastos Personal Año 5", 0, "Gastos de personal proyectados"])
    ws.append(["Gastos Generales Año 1", 0, "Gastos generales proyectados"])
    ws.append(["Gastos Generales Año 2", 0, "Gastos generales proyectados"])
    ws.append(["Gastos Generales Año 3", 0, "Gastos generales proyectados"])
    ws.append(["Gastos Generales Año 4", 0, "Gastos generales proyectados"])
    ws.append(["Gastos Generales Año 5", 0, "Gastos generales proyectados"])
    ws.append(["Gastos Marketing Año 1", 0, "Gastos de marketing proyectados"])
    ws.append(["Gastos Marketing Año 2", 0, "Gastos de marketing proyectados"])
