...
# Buscar el slider de costos variables (alrededor de línea 1750)
for i in range(1745, 1755):
    if i < len(lines):
        ...
        if "step=1," in lines[i] and "costos_variables" in lines[i-3]:
...
if changes == 3:
    with open('app.py', 'w') as f:
        f.writelines(lines)
    print("\n✅ Slider convertido para aceptar decimales")
else:
