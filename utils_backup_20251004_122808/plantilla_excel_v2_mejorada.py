...
def crear_plantilla_v2():
    ...
    try:
        tipos_financiacion = '"Póliza crédito,Póliza crédito stock,Descuento comercial,Anticipo facturas,Factoring con recurso,Factoring sin recurso,Confirming proveedores,Pagarés empresa,Crédito importación"'
        dv_tipos = DataValidation(type="list", 
                                 formula1=tipos_financiacion,
                                 allow_blank=True)
        # Aplicar a las primeras 10 filas de la columna A (tipos de línea)
